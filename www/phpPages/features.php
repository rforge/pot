...
instance, the (univariate) <acronym title="Generalized Pareto
Distribution">GPD</acronym> is currently fitted using <strong>
18 </strong> estimators.  These estimators rely on three different
techniques:
<ul>
  <li>Likelihood maximization:
    <acronym title="Maximum Likelihood Estimate">MLE</acronym>,
    <acronym title="Likelihood Moment Estimate">LME</acronym>,
    <acronym title="Maximum Penalized Likelihood Estimate">MPLE</acronym>
  </li>
  <li>Moment Approaches:
    <acronym title="Method of Moments">MOM</acronym>,
  ...
  <li>Distance Minimization:
    <acronym title="Minimum Power Density Divergence">MDPD</acronym> and
